...
class Minecraft(commands.GroupCog, name="minecraft"):
    ...
    @app_commands.command(name="redeem", description="Get a Twitch redemption code")
    ...
    async def redeem(self, interaction: discord.Interaction):
        ...
        await User(self.client.database).upsert_user(interaction.user, 'minecraft_code', code)
